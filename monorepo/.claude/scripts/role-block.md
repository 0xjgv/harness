...
- If the behavior is law-like (formula, parser, round-trip, invariant), also write a property test with the subproject's PBT tool (hypothesis / fast-check / rapid / proptest).
