...
- Suppressions: `bun run suppressions` — full suppression breakdown (locations are always reported relative to the template root); `--update-baseline` requires human sign-off and updates `.harness-baseline`
